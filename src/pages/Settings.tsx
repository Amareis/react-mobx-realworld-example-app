...
import { userStore, authStore, User } from "/stores";

@observer
class SettingsForm extends React.Component<{onSubmitForm: (user: User) => void}> {
    state: any = {
        image: "",
        username: "",
        bio: "",
...
class Settings extends React.Component {
  handleClickLogout = () =>
    authStore.logout().then(() => this.props.history.replace("/"));
